...
function PublishQuizSuccessPopup({ courseName, onClose, courseId }) {
  return (
    <div className="popup-overlay" onClick={onClose}>
      <div className="popup-card" onClick={(e) => e.stopPropagation()}>
        ...
        <h2 className="popup-title">Quiz Created!</h2>
        <p className="popup-subtitle">
          <strong>{courseName || "Your course"}</strong> is now live and available to students with a quiz.
        </p>

        <div className="popup-actions">
          <Link className="popup-btn popup-btn--quiz" to={`/courses/${courseId}?type=course`}>
...
export default PublishQuizSuccessPopup