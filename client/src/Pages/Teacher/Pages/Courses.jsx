...
const CourseDetailPanel = ({ course, onClose }) => {
    ...
    const avg = averageRating(course.ratings)
    ...
    return (
        <div className="course-detail-panel">
            ...
            <div className="detail-panel-body">
                <span className="course-cat">{course.categoryName}</span>
                <h2>{course.title}</h2>
                ...
                {userRole === "student" && <button className="enroll-btn">Enroll Now</button>}
...
// ─── Course Card (Grid) ───────────────────────────────────────────────────────
export const CourseCard = ({ course, onClick, isSelected }) => {
    return (
        <div
                ...
                <div className="course-features">
                    <div className="flex-left">
                        <div className="flex-line" style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                            <PeopleIcon /> {course.studentsEnrolled}+
                        </div>
                        <div className="flex-line" style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                    ...
                    <div className="flex-line" style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                        <LessonIcon /> {course.lessons.length}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className="course-infos-box">
                    ...
                    <div className="course-features">
                        <div className="flex-left">
                            ...
                            <div className="flex-line feature-card" style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                                <PeopleIcon /> {course.studentsEnrolled} students enrolled
                            </div>
                            <div className="flex-line feature-card" style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                                <CommentIcon /> {course.commentsCount} comments
                            </div>
                            <div className="flex-line feature-card" style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                                <LessonIcon /> {course.lessons.length} lessons
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="courses-wrapper">
                        ...
                        <div className="header-box filter-dropdown" onClick={(e) => { e.stopPropagation(); setViewClicked(true) }}>
                            ...
                            {viewClicked && (
                                <div className="drop-down-box">
                                    <ul>
                                        <li onClick={(e) => { e.stopPropagation(); setViewMode("grid"); setViewClicked(false); setSelectedCourse(null) }}>
                                            Grid Mode <GridIcon />
                                        </li>
                                        <li onClick={(e) => { e.stopPropagation(); setViewMode("line"); setViewClicked(false); setSelectedCourse(null) }}>
                                            Row Mode <LineIcon />
                                        </li>
                                    </ul>
                                </div>
                ...
                {viewMode === "grid" ? (
                    ...
                    <div className="courses-row-container">
                        {mockCourses.map((course) => (
                            <CourseCardLine key={course._id} course={course} />
                        ))}
                    </div>
                )}
            </div>
