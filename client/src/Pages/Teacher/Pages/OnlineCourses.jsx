...
import '../../Student/Styles/Search.css'
...
function OnlineCourses() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const courseRes = await axios.get(`${process.env.REACT_APP_API_URL_GATEWAY}/content/online-courses/recommended/me`)
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            const request = axios.get(
                `${process.env.REACT_APP_API_URL_GATEWAY}/content/online-courses/search?${params.toString()}`
            );
    ...
    const fetchMyCourses = async () => {
        try {
            ...
            const courseRes = await axios.get(`${process.env.REACT_APP_API_URL_GATEWAY}/content/online-courses/me`)
            setCourses(courseRes.data)
    ...
    return (
        <div className="search-page">
            ...
            {userAuth.role === "teacher" &&
                <button className='moc-btn' onClick={fetchMyCourses}>
                    <OnlineCourseIcon />
                    My Online courses
                </button>
            }
            ...
            <div className="search-results-area">
                <OnlineCoursesView courses={courses} teacherCourses={myCoursesClicked} searched={searched} loading={loading} query={query} selectedCats={selectedCats.map(c => c.name).join(', ')} />
            </div>
        </div>
    )
}
