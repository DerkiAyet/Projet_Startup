...
function PostsFeed() {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            setPostAdded(false); // hide the card after 2s
        }, 2000);
    ...
    return (
        <TimeLineContext.Provider value={{ selectedPost, setSelectedPost, posts, setPosts, setPostAdded, followees, setFollowees }}>
