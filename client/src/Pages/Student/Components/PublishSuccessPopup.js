...
function PublishSuccessPopup({ title, onClose, type, id }) {
        ...
        <div className="popup-overlay" onClick={onClose}>
            <div className="popup-card" onClick={(e) => e.stopPropagation()}>
                ...
                <p className="popup-subtitle">
                    <strong>{title || "Your Ressource"}</strong> is now live and available to students.
                </p>

                <div className="popup-actions">
                    <Link className="popup-btn popup-btn--quiz" to={`/courses`}>
