...
import { teacherNavItems, teacherTools, teacherMobileNav } from '../config/navConfig';
...
function TeacherLayout() {
    ...
    return (
        <div className={`main-layout ${minimizeNav ? "shrink-nav" : ""}`}>
            <SideNav minimizeNav={minimizeNav} setMinimizeNav={setMinimizeNav} navItems={teacherNavItems} tools={teacherTools} mobileNavItems={teacherMobileNav} />
